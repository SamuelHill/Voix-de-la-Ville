...
namespace TotT.Simulog {
    ...
    public static class SimuLang {
        ...
        public static Existent<T, T1, T2> Exists<T, T1, T2>(string name, Var<T> arg, IColumnSpec<T1> feature1,
            IColumnSpec<T2> feature2, Var<TimePoint> startArg) =>
        ...
        public static Existent<T, T1, T2, T3> Exists<T, T1, T2, T3>(string name, Var<T> arg, IColumnSpec<T1> feature1, 
            IColumnSpec<T2> feature2, IColumnSpec<T3> feature3, Var<TimePoint> startArg) =>
            new(name, arg, startArg, feature1, feature2, feature3);
        public static Existent<T, T1, T2, T3, T4> Exists<T, T1, T2, T3, T4>(string name, Var<T> arg, IColumnSpec<T1> feature1, 
        ...
        public static Existent<T, T1, T2, T3, T4> Exists<T, T1, T2, T3, T4>(string name, Var<T> arg, IColumnSpec<T1> feature1,
            IColumnSpec<T2> feature2, IColumnSpec<T3> feature3, IColumnSpec<T4> feature4, Var<TimePoint> startArg) =>
            new(name, arg, startArg, feature1, feature2, feature3, feature4);
        public static Existent<T, T1, T2, T3, T4, T5> Exists<T, T1, T2, T3, T4, T5>(string name, Var<T> arg, IColumnSpec<T1> feature1,
        ...
        public static Existent<T, T1, T2, T3, T4, T5> Exists<T, T1, T2, T3, T4, T5>(string name, Var<T> arg, IColumnSpec<T1> feature1, 
            IColumnSpec<T2> feature2, IColumnSpec<T3> feature3, IColumnSpec<T4> feature4, IColumnSpec<T5> feature5, Var<TimePoint> startArg) =>
            new(name, arg, startArg, feature1, feature2, feature3, feature4, feature5);
        public static Existent<T, T1, T2, T3, T4, T5, T6> Exists<T, T1, T2, T3, T4, T5, T6>(string name, Var<T> arg, IColumnSpec<T1> feature1,
            IColumnSpec<T2> feature2, IColumnSpec<T3> feature3, IColumnSpec<T4> feature4, IColumnSpec<T5> feature5, IColumnSpec<T6> feature6) =>
            new(name, arg, start, feature1, feature2, feature3, feature4, feature5, feature6);
        public static Existent<T, T1, T2, T3, T4, T5, T6> Exists<T, T1, T2, T3, T4, T5, T6>(string name, Var<T> arg, IColumnSpec<T1> feature1, IColumnSpec<T2> feature2,
            IColumnSpec<T3> feature3, IColumnSpec<T4> feature4, IColumnSpec<T5> feature5, IColumnSpec<T6> feature6, Var<TimePoint> startArg) =>
            new(name, arg, startArg, feature1, feature2, feature3, feature4, feature5, feature6);
        public static Existent<T, T1, T2, T3, T4, T5, T6, T7> Exists<T, T1, T2, T3, T4, T5, T6, T7>(string name, Var<T> arg, IColumnSpec<T1> feature1, IColumnSpec<T2> feature2,
        ...
        public static Existent<T, T1, T2, T3, T4, T5, T6, T7> Exists<T, T1, T2, T3, T4, T5, T6, T7>(string name, Var<T> arg, IColumnSpec<T1> feature1, IColumnSpec<T2> feature2,
            IColumnSpec<T3> feature3, IColumnSpec<T4> feature4, IColumnSpec<T5> feature5, IColumnSpec<T6> feature6, IColumnSpec<T7> feature7, Var<TimePoint> startArg) => 
        ...
        public static SymmetricRelationship<T> Relationship<T>(string name, Var<SymmetricTuple<T>> pair, Var<T> main, Var<T> other, Var<bool> state) 
            where T : IComparable<T>, IEquatable<T> => new(name, pair, main, other, state);
        public static ExclusiveSymmetricRelationship<T> ExclusiveRelationship<T>(string name, Var<SymmetricTuple<T>> pair, Var<T> main, Var<T> other, Var<bool> state)
            where T : IComparable<T>, IEquatable<T> => new(name, pair, main, other, state);
        ...
        public static Counts<T1, T2> Counts<T1, T2>(string name, Var<T1> countBy, IColumnSpec<T2> arg2,
                                                    Var<int> count) => new(name, countBy, arg2, count);
        public static Counts<T1, T2> Counts<T1, T2>(string name, Var<T1> countBy, IColumnSpec<T2> arg2) => new(name, countBy, arg2, count);
