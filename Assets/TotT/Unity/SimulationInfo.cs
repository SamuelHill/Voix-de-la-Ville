...
namespace TotT.Unity {
    ...
    public class SimulationInfo {
        ...
        public SimulationInfo(TileManager tileManager) => _tileManager = tileManager;
        ...
        // ************************************* Info Strings *************************************
        public static int Population => PopulationCountIndex[true].Item2;
        ...
        private static string BuriedAtCemetery(LocationType locationType) =>
            locationType != LocationType.Cemetery || !Buried.Any() ? "" : 
